...
generated_at: "2026-05-17T21:16:00.314Z"
...
**Families**
- `Inter Variable` · 3618 uses
- `Berkeley Mono` · 315 uses
...
**Shadow scale**
- `sm` — `rgba(94, 106, 210, 0.008) 0px 0px 0px 9.22975px`
...
- Don't 5918 duplicate css declarations.

---
_Generated by [designlang](https://github.com/Manavarya09/design-extract) v12.13.0 from <https://linear.app>._
