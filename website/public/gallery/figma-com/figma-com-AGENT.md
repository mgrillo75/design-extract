# You are building UI in the figma.com design system.
...
- families   figmaSans · figmaMono
- weights    400 · 330 · 320 · 480 · 540 · 340
- base size  16px

## Spacing

- scale      1px · 16px · 24px · 27px · 40px · 44px · 53px · 60px · 64px · 80px · 107px · 120px

## Radii

- scale      2px · 8px · 16px · 50px

## Motion

- durations  100ms · 160ms · 300ms · 500ms
...
- CTA verbs  publish · products · solutions · community · resources · prompt
...
Generated by designlang. Re-extract by running `npx designlang figma.com`.
