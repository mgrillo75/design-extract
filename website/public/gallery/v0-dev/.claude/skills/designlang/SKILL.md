...
description: Use when styling UI for v0.dev — references the extracted design system tokens instead of inventing colors, spacing, or typography.
---

# designlang tokens
Source: https://v0.dev
Extracted by designlang v7.0.0 on 2026-06-25T08:31:40.971Z

## Semantic tokens (use these)
- color.action.primary: #d2d2d2
