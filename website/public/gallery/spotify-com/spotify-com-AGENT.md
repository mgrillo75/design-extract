...
- families   SpotifyMixUI · Times · SpotifyMixUITitle
- weights    400 · 700 · 600 · 500
- base size  16px

## Spacing

- scale      1px · 15px · 20px · 23px · 28px · 35px · 40px · 48px · 64px · 96px · 125px · 154px

## Radii

- scale      2px · 6px · 10px · 16px · 20px · 32px
...
- CTA verbs  sign · log · create · browse · premium · support
...
Generated by designlang. Re-extract by running `npx designlang spotify.com`.
