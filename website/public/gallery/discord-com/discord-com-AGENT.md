# You are building UI in the discord.com design system.
...
- families   Ggsans · Abcgintodiscord · ABC Ginto Normal · Times
- weights    400 · 500 · 700 · 800
- base size  16px

## Spacing

- scale      1px · 24px · 29px · 35px · 48px · 52px · 56px · 60px · 64px · 73px · 76px · 80px

## Radii

- scale      12px · 16px · 40px · 50px · 60px · 72px
...
Generated by designlang. Re-extract by running `npx designlang discord.com`.
