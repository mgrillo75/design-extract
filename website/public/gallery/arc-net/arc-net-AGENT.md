# You are building UI in the arc.net design system.
...
- families   Marlin · Marlin Soft SQ · Times · InterVariable
- weights    400 · 700 · 600 · 500 · 800
- base size  16px

## Spacing

- scale      2px · 32px · 37px · 48px · 64px · 72px · 80px · 90px · 128px · 150px · 155px · 160px
...
Generated by designlang. Re-extract by running `npx designlang arc.net`.
