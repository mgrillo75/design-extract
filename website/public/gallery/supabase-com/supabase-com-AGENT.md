# You are building UI in the supabase.com design system.
...
- secondary   #00bb68
- accent      #a9f1ca
- neutrals    #dfdfdf · #171717 · #525252 · #707070 · #ffffff · #b2b2b2

## Typography

- families   Circular · Source Code Pro
- weights    400 · 500
- base size  16px

## Spacing

- scale      1px · 40px · 48px · 64px · 90px · 112px · 128px · 157px · 208px · 246px · 304px
...
- durations  75ms · 150ms · 200ms · 300ms
...
- CTA verbs  view · nerdburn · patrickc · aliahsan · yatsiv · create

## Component anatomy

- link       variants: [object Object]  ·  slots: —
- card       variants: [object Object]  ·  slots: false · true · true · false
...
Generated by designlang. Re-extract by running `npx designlang supabase.com`.
